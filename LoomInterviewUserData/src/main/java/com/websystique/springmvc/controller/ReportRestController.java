...
public class ReportRestController {
	...
	@RequestMapping(value = "/PutUser", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@CrossOrigin
	public ResponseEntity<Response> putUserData(@RequestParam("emailId") String emailId,@RequestParam("username") String username) {
