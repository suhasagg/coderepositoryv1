...
public class ReportRestController {
	...
	@CrossOrigin
	public ResponseEntity<Response> putUserData(@RequestBody UserDetails user) {
		...
		data.setEmail_id(user.getEmailId());
		data.setUser_id(user.getUsername());
		String key = reportService.UpdateUserData(data,user.getUuid());
	...
	@CrossOrigin
	public ResponseEntity<Response> putUserDatav1(@RequestBody UserDetails user) {
